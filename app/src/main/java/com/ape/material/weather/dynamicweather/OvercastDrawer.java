...
public class OvercastDrawer extends BaseDrawer {
    ...
    protected void setSize(int width, int height) {
        ...
        if (holders.size() == 0) {
            ...
            holders.add(new CloudyDrawer.CircleHolder(0.59f * width, -0.35f * width, -0.18f * width,
                    0.032f * width, 0.6f * width, 0.00125f, isNight ? 0x55374d5c : 0x335a6c78));
            holders.add(new CloudyDrawer.CircleHolder(0.9f * width, -0.18f * width, 0.08f * width,
