...
public class SandDrawer extends BaseDrawer {
    ...
    protected void setSize(int width, int height) {
        ...
        if (this.holders.size() == 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                this.holders.add(new ArcHolder(cx, cy, radiusWidth, radiusHeight, strokeWidth, 30f,
                        99f, sizeDegree, isNight ? 0x99a59056 : 0xbba59056));
            }
        }
    ...
    public static class ArcHolder {
        ...
        public ArcHolder(float cx, float cy, float radiusWidth, float radiusHeight, float strokeWidth,
                         float fromDegree, float endDegree, float sizeDegree, int color) {
            super();
            this.cx = cx;
            this.cy = cy;
