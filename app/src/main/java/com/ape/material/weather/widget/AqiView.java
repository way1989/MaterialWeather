...
public class AqiView extends View {
    ...
    public AqiView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        textSize = UiUtil.dp2px(context, 12);
        paint = new Paint();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int aqiValue = Integer.parseInt(aqi.getAqi());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int desiredWidth = UiUtil.dp2px(getContext(), 100);
        int desiredHeight = UiUtil.dp2px(getContext(), 120);
